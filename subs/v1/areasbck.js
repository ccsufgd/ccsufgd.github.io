const areasData = [{
  ...
  {
    faculdade: 'FADIR',
    area: 'Política Internacional Contemporânea',
    pontosSorteados: [],
    pontos: [
    '1 - Cooperação Internacional e Governança Global;',
    '2 - Organismos Multilaterais e Política Global;',
    '3 - Soberania, Conflitos Internacionais e Intervenções Humanitárias;',
    '4 - Reestruturação Produtiva e Globalização Econômica',
  ...
  {
    faculdade: 'FAED',
    area: 'Pedagogia / Formação de Professores(as)',
    pontosSorteados: [],
    pontos: [
    '1 - Didática, formação de professores e os desafios do Estágio Supervisionado.',
    '2 - Teoria e prática do currículo.',
    '3 - Tendências pedagógicas contemporâneas.',
    '4 - Planejamento e Avaliação da aprendizagem.',
    '5 - Planejamento das práticas pedagógicas.'
  ]
  },
  {
    faculdade: 'FAEN',
    area: 'Engenharia do Trabalho e Desenho Técnico',
    pontosSorteados: [],
    pontos: [
    '1 - Metodologia de análise ergonômica do trabalho.',
    '2 - Convenção 169 da Organização Internacional do Trabalho na América do Sul.',
    '3 - Fundamentos para representações gráficas.',
    '4 - Introdução e uso de software para desenho técnico 2D e 3D.',
    '5 - Planejamento do arranjo físico da produção.'
  ]
  },
  {
    faculdade: 'FAEN',
  ...
  {
    faculdade: 'FAEN',
    area: 'Sistemas de Produção',
    pontosSorteados: [],
    pontos: [
    '1 - Gestão estratégica do desempenho das operações;',
    '2 - Estudo de tempos;',
    '3 - Caracterização do sistema de operações de serviços;',
  ...
  {
    faculdade: 'FCA',
    area: 'Engenharia de aquicultura / Aquicultura',
    pontosSorteados: [],
    pontos: [
    '1 - Cadeia produtiva, mercado e tecnologias disponíveis para peixes nativos do Brasil.',
    '2 - Produção de vegetais aquáticos associados à aquicultura.',
    '3 - Manejo de reprodução de peixes nativos.',
    '4 - Manejo alimentar para peixes nativos.',
    '5 - Produção de alimento vivo para larvicultura de peixes.'
  ]
  },
  {
    faculdade: 'FCA',
    area: 'Agricultura Geral',
    pontosSorteados: [],
    pontos: [
    '1 - Propagação sexuada e assexuada de frutíferas;',
    '2 - Princípios que regem a poda em frutíferas;',
    '3 - Pós-colheita de frutas;',
    '4 - Delineamentos experimentais aplicados na agricultura;',
    '5 - Manejo integrado de doenças de plantas.'
  ]
  },
  {
    faculdade: 'FCA',
    ...
    pontosSorteados: [],
    pontos: [
    '1 - Minerais: conceito, propriedades, classificação; minerais primários e secundários;',
    '2 - Atributos físicos do solo sob diferentes sistemas de manejo;',
    '3 - Sistema Brasileiro de Classificação de Solos;',
    '4 - Práticas de manejo solo para conservação do solo e da água em microbacias hidrográficas;',
    '5 - Biota do solo como reguladora do ecossistema;'
  ]
  },
  {
    faculdade: 'FCA',
    area: 'Eletrônica e Eletrotécnica',
    pontosSorteados: [],
    pontos: [
    '1 - Componentes dos circuitos eletrônicos;',
    '2 - Circuitos de acionamento e controle de potência DC;',
    '3 - Circuitos de acionamento e controle de potência AC;',
    '4 - Controle de fator de potência;',
    '5 - Geradores e motores de corrente alternada.'
  ]
  },
  {
    faculdade: 'FCH',
    area: 'Ciências Sociais / Ciência Política',
    pontosSorteados: [],
    pontos: [
    '1 - Introdução à Política: definição e perspectivas.',
    '2 - Teoria Política Moderna.',
    '3 - Teoria Política Contemporânea.',
    '4 - Democracia, representação e participação política.',
  ...
  {
    faculdade: 'FCS',
    area: 'Ciências Morfofuncionais aplicadas à medicina',
    pontosSorteados: [],
    pontos: [
    '1 - Inflamação aguda',
    '2 - Morte celular: apoptose e necrose',
    '3 - Reparo de lesões: regeneração e cicatrização',
    '4 - Tolerância Imunológica e autoimunidade',
