const areasData = [
    ...
    {
        "faculdade": "FCA",
        "area": "Agronomia/Topografia e Geodésia",
        "pontosSorteados": [],
        "pontos": [
    ...
    },
    {
        ...
        "pontosSorteados": [],
        "pontos": [
            "1- Anatomia do fígado e vias biliares e abordagens cirúgicas: hepatectomia e colecictectomia",
            "2- Parede abdominal",
    ...
    {
        "faculdade": "FACET",
        "area": "Computação / Circuitos Elétricos, Dispositivos Eletrônicos, Sistemas Embarcados e Automação",
        "pontosSorteados": [],
        "pontos": [
            "1- Leis básicas: Carga, Corrente e Tensão, Leis de Ohm e Kirchhoff, Resistores em Série e Paralelo",
            "2- Senoides e Fasores: Senoides , fasores e impedância",
            "3- Polarização CC do TBJ: Ponto de Operação e Configurações de polarização TBJ mais usados.",
            "4- Introdução aos Microcontroladores",
            "5- Instrumentos para Controle de Processos"
        ]
    },
    {
        "faculdade": "FCS",
    ...
    {
        "faculdade": "FAEN",
        "area": "Engenharia de Alimentos / Ciência de Alimentos",
        "pontosSorteados": [],
        "pontos": [
            "1- Ferramentas da Qualidade.",
            "2- Métodos sensoriais discriminativos.",
            "3- Aeração e agitação em processos fermentativos.",
            "4- Princípios básicos da engenharia de segurança do trabalho.",
            "5- Fundamentos para Representações Gráficas."
        ]
    },
    {
        "faculdade": "FAEN",
